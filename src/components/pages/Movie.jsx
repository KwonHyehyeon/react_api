...
const Movie = () => {
  ...
  useEffect(() => {
    fetch(
      "https://api.themoviedb.org/3/movie/popular?api_key=1fb50f08441e9552bb427c8e5f22096d&language=en-US&page=1"
    )
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(
      "https://api.themoviedb.org/3/search/movie?api_key=1fb50f08441e9552bb427c8e5f22096d&query=Disney&page=1"
    )
      .then((response) => response.json())
